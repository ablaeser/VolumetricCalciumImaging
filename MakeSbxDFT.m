...
if ~exist('CS_final','var')
    ...
    save( shiftPath, 'R_zproj','C_zproj','CS_final','RS_final', 'ZS_final', '-append', '-v7.3' ) % save the projection-based results into the existing dft shifts file  ,'zRange'
end
...
rw = pipe.io.RegWriter(sbxPath, sbxInfo, '.sbxdft'); %open regwriter object for writing sbxdft
rw.write(sbx_data);
rw.delete;
toc
end